...
using OpenJinglePlayer;
using OpenJinglePlayer.Lib.Sound.Decoder;

namespace OpenJinglePlayer.Lib.Sound
{
    ...
    class PortAudioStream
    {
            ...
            IntPtr userData)
        {
            ...
            lock (_LockData)
            {
                ...
                float latency = buf.Length / _BytesPerSecond + 100f/1000f;
